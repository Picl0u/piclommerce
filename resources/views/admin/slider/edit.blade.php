...
@section("content")
    ...
    <div class="content-container">
        ...
        <div class="translate-actions">
            {!! formTranslate(\Piclou\Piclommerce\Http\Entities\Slider::class, $data)
            ->action('admin.sliders.translate')
            ->render() !!}
        </div>
        <form class="admin-form" method="post" action="{{ route('admin.sliders.update',['uuid' => $data->uuid]) }}" enctype="multipart/form-data">
            {{ csrf_field() }}
