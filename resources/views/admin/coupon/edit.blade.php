...
@section("content")
        ...
        <div class="is-row align-middle">
            ...
            <div class="is-col text-right">
                <nav class="breadcrumb">
                    ...
                    <a href="{{ route("admin.coupon.index") }}">{{ __('piclommerce::admin.navigation_promotional') }}</a>
                    <span>{{ __('piclommerce::admin.edit') }} {{ $data->name }}</span>
                </nav>
            </div>
        </div>
    ...
    <div class="content-container">
        ...
        <form class="admin-form" method="post" action="{{ route('admin.coupon.update',['uuid' => $data->uuid]) }}" enctype="multipart/form-data">
            {{ csrf_field() }}
            @include("piclommerce::admin.coupon.form", compact('data'))
