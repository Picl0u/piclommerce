...
@section("content")
        ...
        <div class="is-row align-middle">
            ...
            <div class="is-col text-right">
                <nav class="breadcrumb">
                    ...
                    <a href="{{ route("admin.pages.categories.index") }}">{{ __('piclommerce::admin.navigation_sections') }}</a>
    ...
    <div class="content-container">
        ...
        <div class="translate-actions">
            {!! formTranslate(\Piclou\Piclommerce\Http\Entities\ContentCategory::class, $data)
            ->action('admin.pages.categories.translate')
            ->render() !!}
        </div>
        <form class="admin-form" method="post" action="{{ route('admin.pages.categories.update',['uuid' => $data->uuid]) }}" enctype="multipart/form-data">
            {{ csrf_field() }}
            @include("piclommerce::admin.contentCategories.form", compact('data'))
