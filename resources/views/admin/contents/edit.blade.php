...
@section("content")
    ...
    <div class="content-container">
        ...
        <div class="translate-actions">
            {!! formTranslate(\Piclou\Piclommerce\Http\Entities\Content::class, $data)
            ->action('admin.shop.categories.translate')
            ->render() !!}
        </div>
        <form class="admin-form" method="post" action="{{ route('admin.pages.contents.update',['uuid' => $data->uuid]) }}" enctype="multipart/form-data">
            {{ csrf_field() }}
            @include("piclommerce::admin.contents.form", compact('data'))
