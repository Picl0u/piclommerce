...
@section("content")
        ...
        <div class="is-row align-middle">
            ...
            <div class="is-col text-right">
                <nav class="breadcrumb">
                    ...
                    <span>{{ __('piclommerce::admin.navigation_categories') }}</span>
                </nav>
            </div>
        </div>
    </div>
    <div class="content-container">
        <div class="button-actions">
            ...
            <a href="{{ route("admin.shop.categories.positions") }}">
        ...
        <div class="datatable-container">
            <table class="datatable display" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <th>{{ __('piclommerce::admin.shop_categories_name') }}</th>
    ...
    <script>
        jQuery(function() {
            jQuery('.datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax : "{{ route('admin.shop.categories.index') }}",
                columns: [
                    { data: 'id', name: 'id' },
