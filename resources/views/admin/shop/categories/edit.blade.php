...
@section("content")
    ...
    <div class="content-container">
        ...
        <div class="translate-actions">
            {!! formTranslate(\Piclou\Piclommerce\Http\Entities\ShopCategory::class, $data)
            ->action('admin.shop.categories.translate')
            ->render() !!}
        </div>
        <form class="admin-form" method="post" action="{{ route('admin.shop.categories.update',['uuid' => $data->uuid]) }}" enctype="multipart/form-data">
            {{ csrf_field() }}
