...
@section("content")
    ...
    <div class="content-container">
        ...
        <div class="translate-actions">
            {!! formTranslate(\Piclou\Piclommerce\Http\Entities\Product::class, $data)
            ->action('admin.shop.categories.translate')
            ->render() !!}
        </div>
        <form class="admin-form" method="post" action="{{ route('admin.shop.products.update',['uuid' => $data->uuid]) }}" enctype="multipart/form-data">
            {{ csrf_field() }}
            @include("piclommerce::admin.shop.products.form", compact('data'))
